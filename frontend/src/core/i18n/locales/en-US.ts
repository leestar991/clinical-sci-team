...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to NextTask, an open source super agent. With built-in and custom skills, NextTask helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of NextTask. With customized skills,\nNextTask can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  // Workspace
  workspace: {
    officialWebsite: "NextTask's official website",
    githubTooltip: "NextTask on Github",
    settingsAndMore: "Settings and more",
    visitGithub: "NextTask on GitHub",
    reportIssue: "Report a issue",
    contactUs: "Contact us",
    about: "About NextTask",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to NextTask",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate NextTask faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how NextTask looks and behaves for you.",
    sections: {
    ...
    memory: {
      title: "Memory",
      description:
        "NextTask automatically learns from your conversations in the background. These memories help NextTask understand you better and deliver a more personalized experience.",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of NextTask.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "NextTask only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
